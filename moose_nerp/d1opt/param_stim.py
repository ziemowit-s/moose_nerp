...
Fino_Pre = ParadigmParams(f_pulse=50., n_pulse=1, A_inject=0.38e-9, f_burst=1, n_burst=1, f_train=1, n_train=1,
                          width_AP=0.030, AP_interval=0.01, n_AP=1, ISI=-0.010, name="Fino_Pre")
Fino_Post = ParadigmParams(f_pulse=50., n_pulse=1, A_inject=0.38e-9, f_burst=1, n_burst=1, f_train=1, n_train=100,
                           width_AP=0.030, AP_interval=0.01, n_AP=1, ISI=-0.040, name="Fino_Pre")
...
Kerr_and_Plenz = ParadigmParams(f_pulse=100, n_pulse=0, A_inject=1e-9, f_burst=1, n_burst=1, f_train=1, n_train=1,
                                width_AP=0.005, AP_interval=0.1, n_AP=5, ISI=0, name="Kerr_and_Plenz")

## Pawlak and Kerr Pre and Post should work (worked for Asia)
Pawlak_and_Kerr_Pre = ParadigmParams(f_pulse=50, n_pulse=1, A_inject=1e-9, f_burst=1, n_burst=1, f_train=0.1,
                                     n_train=60, width_AP=0.005, AP_interval=1. / 50., n_AP=3, ISI=0.01,
                                     name="Pawlak_and_Kerr_Pre")

Pawlak_and_Kerr_Post = ParadigmParams(f_pulse=50, n_pulse=1, A_inject=1e-9, f_burst=1, n_burst=1, f_train=0.1,
                                      n_train=60, width_AP=0.005, AP_interval=1. / 50., n_AP=3, ISI=-0.03,
                                      name="Pawlak and_Kerr_Post")

# Didn't work very well for Asia
Pawlak_and_Kerr_1_AP_Pre = ParadigmParams(f_pulse=50, n_pulse=1., A_inject=1e-9, f_burst=1, n_burst=1, f_train=0.1,
                                          n_train=60, width_AP=0.005, AP_interval=1. / 50., n_AP=1, ISI=0.01,
                                          name="Pawlak_and_Kerr_1_AP_Pre")

Pawlak_and_Kerr_1_AP_Post = ParadigmParams(f_pulse=50, n_pulse=1., A_inject=1e-9, f_burst=1, n_burst=1, f_train=0.1,
                                           n_train=60, width_AP=0.005, AP_interval=1. / 50., n_AP=1, ISI=-0.03,
                                           name="Pawlak_and_Kerr_1_AP_Post")
...
Shen_Pre = ParadigmParams(f_pulse=50., n_pulse=3, A_inject=1e-9, f_burst=5, n_burst=5, f_train=0.1, n_train=10,
                          width_AP=0.005, AP_interval=1. / 50., n_AP=3, ISI=0.005, name="Shen_Pre")

Shen_Post = ParadigmParams(f_pulse=50., n_pulse=1, A_inject=1e-9, f_burst=5, n_burst=5, f_train=0.1, n_train=10,
                           width_AP=0.005, AP_interval=1. / 50., n_AP=3, ISI=-0.01, name="Shen_Post")
...
inject = ParadigmParams(f_pulse=5, n_pulse=0, A_inject=0.25e-9, f_burst=1, n_burst=1, f_train=1, n_train=1,
                        width_AP=0.4, AP_interval=0.01, n_AP=1, ISI=0, name="inject")
...
location = StimLocParams(which_spines=[0], spine_density=1, pulse_sequence=None,
                         stim_dendrites=['tertdend1_1'])  # Add probability of stimulation.
...
Stimulation = StimParams(Paradigm=PSP_1, stim_delay=0.05, StimLoc=location)
