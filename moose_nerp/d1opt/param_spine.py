...
SpineParams = _util.NamedDict(
    ...
    spineStart=26.1e-6,
    spineEnd=300e-6,
    explicitSpineDensity=.1e6,
    # Density of spines to explicitly model, Should be < or = to spineDensity. TODO: Consider changing to Fraction of SpineDensity
    spineChanList=[[('CaL13', _condfrac)], [('CaL12', _condfrac), ('CaR', _condfrac), ('CaT', _condfrac)]],
    # TODO: Specify for each channel the gbar ratio as a dictionary or named dict rather than list; also specify which difshell;
