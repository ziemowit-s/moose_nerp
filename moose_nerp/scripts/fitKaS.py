...
resY = scipy.optimize.differential_evolution(fit, bounds, args=(yInfWolf, yTauWolf), tol=1e-15,
                                             maxiter=200)  # ,mutation=1.9,seed=12,popsize=60,recombination=0.2)
...
resX = scipy.optimize.differential_evolution(fit, bounds, args=(xInfWolf, xTauWolf), tol=1e-15,
                                             maxiter=200)  # ,mutation=1.9,seed=12,popsize=60,recombination=0.2)
...
rateMult = 1e-3 / 3.
vMult = 1e3
X_model = (param_chan.KaS_X_params.A_rate * rateMult, param_chan.KaS_X_params.A_vhalf * vMult,
           param_chan.KaS_X_params.A_vslope * vMult, param_chan.KaS_X_params.B_rate * rateMult,
           param_chan.KaS_X_params.B_vhalf * vMult, param_chan.KaS_X_params.B_vslope * vMult)
Y_model = (param_chan.KaS_Y_params.A_rate * rateMult, param_chan.KaS_Y_params.A_vhalf * vMult,
           param_chan.KaS_Y_params.A_vslope * vMult, param_chan.KaS_Y_params.B_rate * rateMult,
           param_chan.KaS_Y_params.B_vhalf * vMult, param_chan.KaS_Y_params.B_vslope * vMult)
