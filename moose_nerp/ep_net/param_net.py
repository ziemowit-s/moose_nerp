...
neur1pre_neur1post = connect(synapse='gaba', pre='ep', post='gaba', probability=0.5,
...
ep['gaba'] = {'extern2': ext2_neur1post,
              'extern3': ext3_neur1post}  # , 'extern4': ext4_neur1post}#, 'ep':neur1pre_neur1post}
